 ...
 * [Как извлечь МетаДанные из PSD-файла : : Исходный код Экстрактора Метаданных! Дядя Вова : : Скрипач не нуже,родной от только лишнее топливо жрет! Верстальщик сайтов не нужен!](https://docs.google.com/document/d/1loNuSXsm3kMWAPosGrMNexQKvTE-dqvjBRlMOxsQwx4/)
...
* [Глубокие нейросети для анализа Биржевой информации (Часть 1). Подготовка данных.](https://www.mql5.com/ru/articles/3486)

* [Глубокие нейросети для анализа Биржевой информации (Часть 2). Разработка и выбор предикторов.](https://www.mql5.com/ru/articles/3507)
